<template>
  <jet-action-section>
    ...
    <template #content>
      ...
      <div>
        Se necessário, você pode sair de todas as outras sessões do navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo; no entanto, esta lista pode estar incompleta. Se você acha que sua conta foi comprometida, você também deve atualizar sua senha.
      </div>
